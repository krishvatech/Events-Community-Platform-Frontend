...
function toCard(ev, isPinnedTopCopy = false) {
  ...
  return {
    ...
    linkedin_summary_url: ev.linkedin_summary_url || "",
    replay_cta_text: ev.replay_cta_text || "Sign up to watch full replay",
    replay_signup_enabled: !!ev.replay_signup_enabled,
    can_signup_for_replay: !!ev.can_signup_for_replay,
    has_replay_access: !!ev.has_replay_access,
