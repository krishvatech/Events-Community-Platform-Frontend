  ...
  <footer className="border-t border-[#1bbbb3]/30">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-center gap-4 md:gap-6">
        ...
        <nav className="flex flex-wrap justify-center gap-x-10 gap-y-3 text-base text-neutral-600">
        ...
        <div className="flex justify-center md:justify-self-end gap-4 text-neutral-500">
          <a href="#" className="hover:text-teal-600" aria-label="Twitter">
          ...
          <a href="#" className="hover:text-teal-600" aria-label="LinkedIn">
            <svg width="24" height="24" viewBox="0 0 256 256" fill="currentColor">
